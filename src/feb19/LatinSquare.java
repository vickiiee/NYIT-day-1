...
public class LatinSquare {
	...
	public static void main(String[] args) {
		/*
		 * int[][] arr2D = { { 10, 30, 20, 0 }, { 0, 20, 30, 10 }, { 30, 0, 10, 20 }, {
		 * 20, 10, 0, 30 } };
		 * 
		 * int[][] arr2D = { { 1, 2, 3 }, { 3, 1, 2 }, { 2, 3, 1 }, };
		 * 
		 * int[][] arr2D = { { 1, 2, 3 }, { 3, 1, 2 }, { 7, 8, 9 }, };
		 * 
		 * 
		 * int[][] arr2D = { { 10, 30, 20, 0 }, { 20, 20, 30, 10 }, { 30, 0, 10, 20 }, {
		 * 20, 10, 0, 30 } };
		 */
		int[][] arr2D = { { 10, 30, 20, 0 }, { 0, 20, 30, 10 }, { 30, 0, 10, 16 }, { 20, 10, 0, 30 } };
...
//System.out.println(arr2d[i][q]);
					if (val.indexOf(" " + arr2d[i][q]) == -1) {
						System.out.println("\nRow " + i + " does not have all row 0 elements");
						return false;
					}
				}
			}
...
//System.out.println("(" + j + "),(" + i + "): " + temp[j]);
		...
		/*
		 * is true if: - square -no duplicates in each row/column -
		 */
